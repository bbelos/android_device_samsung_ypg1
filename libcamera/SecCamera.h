...
#define S5K4ECGX_POSTVIEW_WIDTH           320
#define S5K4ECGX_POSTVIEW_WIDE_WIDTH      400
#define S5K4ECGX_POSTVIEW_HEIGHT          240
...
#define VGA_POSTVIEW_WIDTH              640
#define VGA_POSTVIEW_WIDE_WIDTH         800
#define VGA_POSTVIEW_HEIGHT             480
...
#define FRONT_CAMERA_POSTVIEW_WIDTH         JOIN(FRONT_CAM,_POSTVIEW_WIDTH)
#define FRONT_CAMERA_POSTVIEW_WIDE_WIDTH    JOIN(FRONT_CAM,_POSTVIEW_WIDE_WIDTH)
#define FRONT_CAMERA_POSTVIEW_HEIGHT        JOIN(FRONT_CAM,_POSTVIEW_HEIGHT)
#define FRONT_CAMERA_POSTVIEW_BPP           JOIN(FRONT_CAM,_POSTVIEW_BPP)
